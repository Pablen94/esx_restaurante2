...
function OpenSocietyActionsMenu()
  ...
  if (isBarman) then
    table.insert(elements, {label = _U('crafting'),    value = 'menu_crafting_barman'})
  end
  if (isCooker) then
    table.insert(elements, {label = _U('crafting'),    value = 'menu_crafting_cooker'})
  end
      ...
      if data.current.value == 'menu_crafting_barman' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('esx_restaurantejob:craftingDrinks', data2.current.value)
